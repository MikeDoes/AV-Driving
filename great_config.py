...
MIN_DELTA = .00005               #early stop will want this much loss change before calling it improved.
PRINT_MODEL_SUMMARY = True      #print layers and weights to stdout
OPTIMIZER = 'adam'                #adam, sgd, rmsprop, etc.. None accepts default
LEARNING_RATE = 0.01           #only used when OPTIMIZER specified
LEARNING_RATE_DECAY = 0.05       #only used when OPTIMIZER specified
