...
def train(cfg, tub_names, model_name, transfer_model, model_type, continuous, aug):
    ...
    kl = my_get_model_by_type(train_type, cfg=cfg)
...
def sequence_train(cfg, tub_names, model_name, transfer_model, model_type, continuous, aug):
    ...
    kl = my_get_model_by_type(model_type, cfg=cfg)
...
def my_get_model_by_type(model_type, cfg):
    '''
    ...
    elif model_type == "linear_tanh":
        kl = KerasLinear(input_shape=input_shape, roi_crop=roi_crop, last_activation="tanh")
