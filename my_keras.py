...
class KerasLinear(KerasPilot):
    ...
    def __init__(self, num_outputs=2, input_shape=(120, 160, 3), roi_crop=(0, 0), last_activation="linear", *args, **kwargs):
        ...
        self.model = default_n_linear(num_outputs, input_shape, roi_crop, last_activation=last_activation)
        self.compile()
...
def default_n_linear(num_outputs, input_shape=(120, 160, 3), roi_crop=(0, 0), last_activation="linear"):
